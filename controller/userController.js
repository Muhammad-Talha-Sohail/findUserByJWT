...
const signup = async (req, res)=>{
    try {
        ...
        await user.save();
        const token = Auth.signToken(req.body);
        return res.status(200).json({message: "User Successfully Registered", user, token});
    }
    catch(error){
        const warn = Object.keys(error).length === 0;
        return res.status(400).json({message: warn ? "Error Occur while Registration" : error});
    }
}
...
const login = async (req, res)=>{
    try {
        ...
        const warn = Object.keys(error).length === 0;
        return res.status(400).json({message: warn ? "Error Occur while Login" : error});
    }
}
...
const getUserByEmail = async (req, res)=>{
    try {
        ...
        const warn = Object.keys(error).length === 0;
        return res.status(400).json({message: warn ? "Error Occur while Finding User by Email" : error});
    }
}
...
const getUserById = async (req, res)=>{
    try {
        ...
        const warn = Object.keys(error).length === 0;
        return res.status(400).json({message: warn ? "Error Occur while Finding User by ID" : error});
    }
}
...
const updateUserByEmail = async (req, res)=>{
    try {
        ...
        const warn = Object.keys(error).length === 0;
        return res.status(400).json({message: warn ? "Error Occur while Updating User by Email" : error});
    }
}
...
const updateUserById = async (req, res)=>{
    try {
        ...
        const warn = Object.keys(error).length === 0;
        return res.status(400).json({message: warn ? "Error Occur while Updating User by ID" : error});
    }
}
...
const deleteUserByEmail = async (req, res)=>{
    try {
        ...
        const warn = Object.keys(error).length === 0;
        return res.status(400).json({message: warn ? "Error Occur while Deleting User by Email" : error});
    }
}
...
const deleteUserById = async (req, res)=>{
    try {
        ...
        const warn = Object.keys(error).length === 0;
        return res.status(400).json({message: warn ? "Error Occur while Deleting User by ID" : error});
    }
}
